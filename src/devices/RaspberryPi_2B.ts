...
export default class RaspberryPi_2B extends Device {
    ...
    static board = {
        ...
        8: { chip: 0, line: 14 }, //GPIO14 and TXD (TXD0) [UART TX]
        10: { chip: 0, line: 15 }, //GPIO15 and RXD (TXD1) [UART RX]
    ...
    static bcm = {
        ...
        PWM1: this.board[33],
        GPIO14: this.board[8], //GPIO14 and TXD (TXD0) [UART TX]
        TXD: this.board[8],
        TXD0: this.board[8],
        UART_TX: this.board[8],
        GPIO15: this.board[10], //GPIO15 and RXD (TXD1) [UART RX]
        RXD: this.board[10],
        TXD1: this.board[10],
